...
@author: ITS265 Lab2 Starter Code  & Sharyl Riley and Jesse Eddy
"""
import time
...
class Robot:
    ...
    def MoveRobot(self):
        ...
        if self.Orientation == "North":
            ...
            elif self.FrontSensor == 1 and self.LeftSensor == 1 and self.RightSensor ==1:
                self.positionX = self.positionX +1
                self.positionY = self.PositionY 
    ...
    # 
    def IsVisited(self):
        if (TaskEnvModel[self.positionX][self.positionY] == 0 or TaskEnvModel[self.positionX][self.positionY] == 2) and VisitedModel[self.positionX][self.positionY] == 0:
            print("It has not been visited.")
            return False
        else:
            print("This position has been visited.")
            return True
